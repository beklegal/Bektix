...
export async function migrate() {
  ...
  try {
    ...
    await client.query(`CREATE TABLE IF NOT EXISTS daily_metrics (shop_id uuid NOT NULL REFERENCES shops(id) ON DELETE CASCADE, branch_id uuid NULL REFERENCES branches(id) ON DELETE SET NULL, metric_date date NOT NULL, sales_count integer NOT NULL DEFAULT 0, revenue numeric NOT NULL DEFAULT 0, gross_profit numeric NOT NULL DEFAULT 0, items_sold integer NOT NULL DEFAULT 0, updated_at timestamptz NOT NULL DEFAULT now(), PRIMARY KEY(shop_id, branch_id, metric_date))`);
